...
def graphSearch_cornersProblem(problem, frontier, start_location, goal_locations):
    ...
    while not frontier.isEmpty():
        ...
        # check if all ne connections have been found
...
def calculateTourCost(tour: list, connections: list) -> int:
    ...
    for i in range(len(tour) - 1):
        ...
        for c in connections:  # replace this section with dict
...
def breadthFirstSearch(problem):
    ...
    if hasattr(problem, "iam") and problem.iam == "CornersProblem":
        ...
        all_locations = problem.startingLocations
...
def weightedGraphSearch_cornersProblem(problem, frontier, start_location, goal_locations, heuristic=nullHeuristic):
    ...
    while not frontier.isEmpty():
        ...
        # check if all new connections have been found
        if len(goal_locations) == len(connections_found):
            return connections_found
